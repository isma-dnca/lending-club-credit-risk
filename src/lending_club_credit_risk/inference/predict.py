...
def _prepare_inference_input(
    ...
    Load raw inference data and apply the deterministic preprocessing steps.
...
def predict_from_csv(
    ...
    """
    Run inference on a raw CSV file using saved model artifacts.

    Parameters
    ----------
    input_file : str or Path
        Path to the raw CSV file containing new observations, unseen data.
    ...
    X, row_ids = _prepare_inference_input(
